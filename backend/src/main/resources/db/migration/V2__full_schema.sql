-- =============================================================================
-- V2__full_schema.sql – All domain tables with tenant_id for RLS
-- =============================================================================
...
CREATE INDEX idx_customer_price_groups_tenant_id ON customer_price_groups(tenant_id);
...
CREATE INDEX idx_station_shifts_tenant_id ON station_shifts(tenant_id);
...
CREATE INDEX idx_job_status_history_tenant_id ON job_status_history(tenant_id);
...
CREATE INDEX idx_quality_checks_tenant_id ON quality_checks(tenant_id);
...
CREATE INDEX idx_quality_defects_tenant_id ON quality_defects(tenant_id);
...
CREATE TABLE machines (
    ...
    created_at          TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
    updated_at          TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
    UNIQUE(tenant_id, machine_number)
);
...
CREATE INDEX idx_machine_availability_tenant_id ON machine_availability(tenant_id);
...
CREATE INDEX idx_maintenance_intervals_tenant_id ON maintenance_intervals(tenant_id);
...
CREATE INDEX idx_machine_incidents_tenant_id ON machine_incidents(tenant_id);
...
CREATE INDEX idx_employee_qualifications_tenant_id ON employee_qualifications(tenant_id);
...
CREATE INDEX idx_time_corrections_tenant_id ON time_corrections(tenant_id);
...
CREATE INDEX idx_supplier_articles_tenant_id ON supplier_articles(tenant_id);
...
CREATE INDEX idx_supplier_price_lists_tenant_id ON supplier_price_lists(tenant_id);
CREATE INDEX idx_supplier_price_lists_supplier_article_id ON supplier_price_lists(supplier_article_id);

-- ===================== STUECKLISTEN & KALKULATION =====================
...
CREATE INDEX idx_bom_versions_tenant_id ON bom_versions(tenant_id);
...
CREATE INDEX idx_bom_items_tenant_id ON bom_items(tenant_id);
...
CREATE INDEX idx_process_plans_tenant_id ON process_plans(tenant_id);
...
CREATE INDEX idx_process_steps_tenant_id ON process_steps(tenant_id);
...
CREATE INDEX idx_cost_rates_tenant_id ON cost_rates(tenant_id);
...
CREATE INDEX idx_job_calculations_tenant_id ON job_calculations(tenant_id);
...
CREATE INDEX idx_conversation_tags_tenant_id ON conversation_tags(tenant_id);
...
CREATE INDEX idx_conversation_links_tenant_id ON conversation_links(tenant_id);
...
CREATE INDEX idx_document_links_tenant_id ON document_links(tenant_id);
...
CREATE INDEX idx_agent_run_steps_tenant_id ON agent_run_steps(tenant_id);
...
CREATE INDEX idx_agent_incidents_tenant_id ON agent_incidents(tenant_id);
...
CREATE INDEX idx_agent_event_subs_tenant_id ON agent_event_subscriptions(tenant_id);
...
CREATE INDEX idx_tenant_llm_config_tenant_id ON tenant_llm_config(tenant_id);
