...
public class UserService {
    ...
    @Transactional
    public UserEntity create(String email, String password, String firstName, String lastName, Role role, UUID tenantId) {
        if (userRepository.existsByEmailAndTenantId(email, tenantId)) {
            throw new IllegalArgumentException("Email already in use for this tenant: " + email);
        }
        ...
        user.setActive(true);
        log.info("Creating user: {} with role {} for tenant {}", email, role, tenantId);
