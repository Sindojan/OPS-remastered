...
public class CustomerService {
    ...
    @Transactional
    public CustomerPriceGroupEntity addPriceGroup(UUID customerId, com.owlsburg.ops.customers.dto.PriceGroupRequest request) {
        CustomerEntity customer = findById(customerId);
    ...
    public CustomerPriceGroupEntity updatePriceGroup(UUID customerId, UUID priceGroupId,
                                                     com.owlsburg.ops.customers.dto.PriceGroupRequest request) {
        findById(customerId);
